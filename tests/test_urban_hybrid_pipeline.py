...
def test_hybrid_classifier_returns_unknown_for_cross_group_weak_conflict(monkeypatch):
    ...
    _assert_explainability_contract(result)
    assert result["binary_audit_resolution_action"].endswith("_binary_resolved")
