...
def postprocess_urban_predictions(
    ...
    *,
    ...
    binary policy is the final batch reconciliation layer.
    """
    ...
    # 3) Final binary policy layer: last authority over binary reconciliation.
    if not _binary_policy_v2_enabled(context):
        return enriched
